...
pub const DUK_VERSION: u32 = 20201;
pub const DUK_GIT_COMMIT: &'static [u8; 41usize] = b"25420e773c5fbc50d5b46bf487fc45717e35b94f\0";
pub const DUK_GIT_DESCRIBE: &'static [u8; 7usize] = b"v2.2.1\0";
pub const DUK_GIT_BRANCH: &'static [u8; 17usize] = b"v2.2-maintenance\0";
